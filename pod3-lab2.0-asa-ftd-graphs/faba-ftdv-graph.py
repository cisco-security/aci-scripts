...
for pod_num in range(pod_num_start, (1 + pod_num_end)):
    ...
    vnsRsMConnAtt = cobra.model.vns.RsMConnAtt(vnsAbsFuncConn, tDn=u'uni/infra/mDev-Cisco-FTD-1.0/mFunc-FTD/mConn-external')
    vnsAbsFuncConn2 = cobra.model.vns.AbsFuncConn(vnsAbsNode, ownerKey=u'', attNotify=u'no', name=u'provider', descr=u'', ownerTag=u'')
    vnsRsMConnAtt2 = cobra.model.vns.RsMConnAtt(vnsAbsFuncConn2, tDn=u'uni/infra/mDev-Cisco-FTD-1.0/mFunc-FTD/mConn-internal')
    ...
    vnsRsNodeToMFunc = cobra.model.vns.RsNodeToMFunc(vnsAbsNode, tDn=u'uni/infra/mDev-Cisco-FTD-1.0/mFunc-FTD')
    vnsRsNodeToLDev = cobra.model.vns.RsNodeToLDev(vnsAbsNode, tDn=u'uni/tn-pod%d/lDevVip-pod%d-vFTD-l3fw' % (pod_num,pod_num))
