...
for pod_num in range(pod_num_start, (1 + pod_num_end)):
        ...
        vnsAbsFolder21 = cobra.model.vns.AbsFolder(vnsAbsFolder20, locked=u'no', name=u'externalIfCfg', devCtxLbl=u'', scopedBy=u'epg', profileBehaviorShared=u'no', key=u'InterfaceConfig', cardinality=u'unspecified')
        vnsAbsParam25 = cobra.model.vns.AbsParam(vnsAbsFolder21, validation=u'', mandatory=u'no', name=u'external_security_level', value=u'50', key=u'security_level', locked=u'no', cardinality=u'unspecified')
        vnsAbsFolder22 = cobra.model.vns.AbsFolder(vnsAbsFolder21, locked=u'no', name=u'mac_address', devCtxLbl=u'', scopedBy=u'epg', profileBehaviorShared=u'no', key=u'mac_address', cardinality=u'unspecified')
        vnsAbsParam26 = cobra.model.vns.AbsParam(vnsAbsFolder22, validation=u'', mandatory=u'yes', name=u'active_mac', value=u'0010.0003.0001', key=u'active_mac', locked=u'no', cardinality=u'unspecified')
        vnsAbsFolder23 = cobra.model.vns.AbsFolder(vnsAbsFolder21, locked=u'no', name=u'IPv4Address', devCtxLbl=u'', scopedBy=u'epg', profileBehaviorShared=u'no', key=u'IPv4Address', cardinality=u'unspecified')
        vnsAbsParam27 = cobra.model.vns.AbsParam(vnsAbsFolder23, validation=u'', mandatory=u'yes', name=u'ipv4_address', value=u'10.3.0.1/255.255.255.0', key=u'ipv4_address', locked=u'no', cardinality=u'unspecified')
        vnsAbsFolder24 = cobra.model.vns.AbsFolder(vnsAbsFolder20, locked=u'no', name=u'StaticRoute', devCtxLbl=u'', scopedBy=u'epg', profileBehaviorShared=u'no', key=u'StaticRoute', cardinality=u'unspecified')
        vnsAbsFolder25 = cobra.model.vns.AbsFolder(vnsAbsFolder24, locked=u'no', name=u'route', devCtxLbl=u'', scopedBy=u'epg', profileBehaviorShared=u'no', key=u'route', cardinality=u'unspecified')
        vnsAbsParam28 = cobra.model.vns.AbsParam(vnsAbsFolder25, validation=u'', mandatory=u'yes', name=u'gateway', value=u'10.3.0.2', key=u'gateway', locked=u'no', cardinality=u'unspecified')
        vnsAbsParam29 = cobra.model.vns.AbsParam(vnsAbsFolder25, validation=u'', mandatory=u'yes', name=u'network', value=u'0.0.0.0', key=u'network', locked=u'no', cardinality=u'unspecified')
        vnsAbsParam30 = cobra.model.vns.AbsParam(vnsAbsFolder25, validation=u'', mandatory=u'yes', name=u'netmask', value=u'0.0.0.0', key=u'netmask', locked=u'no', cardinality=u'unspecified')
        vnsAbsFolder26 = cobra.model.vns.AbsFolder(vnsAbsFolder20, locked=u'no', name=u'ExtAccessGroup', devCtxLbl=u'', scopedBy=u'epg', profileBehaviorShared=u'no', key=u'AccessGroup', cardinality=u'unspecified')
        ...
        vnsAbsFolder27 = cobra.model.vns.AbsFolder(vnsAbsFuncCfg, locked=u'no', name=u'ExtConfig', devCtxLbl=u'', scopedBy=u'epg', profileBehaviorShared=u'yes', key=u'ExIntfConfigRelFolder', cardinality=u'unspecified')
        vnsAbsCfgRel2 = cobra.model.vns.AbsCfgRel(vnsAbsFolder27, mandatory=u'no', name=u'ExtConfigrel', key=u'ExIntfConfigRel', locked=u'no', cardinality=u'unspecified', targetName=u'externalIf')
