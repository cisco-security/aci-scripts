...
# build the request using cobra syntax
    ...
    vnsRsLIfCtxToLIf = cobra.model.vns.RsLIfCtxToLIf(vnsLIfCtx, tDn=u'uni/tn-pod%d/lDevVip-vFTD-l3fw/lIf-app' % (pod_num))
    ...
    vnsRsLIfCtxToLIf2 = cobra.model.vns.RsLIfCtxToLIf(vnsLIfCtx2, tDn=u'uni/tn-pod%d/lDevVip-vFTD-l3fw/lIf-db' % (pod_num))
    vnsRsLDevCtxToLDev = cobra.model.vns.RsLDevCtxToLDev(vnsLDevCtx, tDn=u'uni/tn-pod%d/lDevVip-vFTD-l3fw' % (pod_num))
