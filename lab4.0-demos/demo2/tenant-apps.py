...
fvTenant = cobra.model.fv.Tenant(polUni, ownerKey=u'', name=u'%s' % tenant_name, descr=u'', ownerTag=u'')

aaaDomainRef = cobra.model.aaa.DomainRef(fvTenant, ownerKey=u'', name=u'ACI-Security-Integration', descr=u'', ownerTag=u'')
aaaDomainRef = cobra.model.aaa.DomainRef(fvTenant, ownerKey=u'', name=u'SecDo-%s' % tenant_name, descr=u'', ownerTag=u'')
...
fvBD = cobra.model.fv.BD(fvTenant, ownerKey=u'', name=u'BD1', descr=u'', unkMacUcastAct=u'flood', arpFlood=u'yes', limitIpLearnToSubnets=u'no', llAddr=u'::', mac=u'00:22:BD:F8:19:FF', epMoveDetectMode=u'', unicastRoute=u'yes', ownerTag=u'', multiDstPktAct=u'bd-flood', unkMcastAct=u'flood')
...
fvSubnet = cobra.model.fv.Subnet(fvBD, name=u'', descr=u'', ctrl=u'', ip=u'10.1.0.2/16', preferred=u'no', scope=u'public')
fvRsBdToEpRet3 = cobra.model.fv.RsBdToEpRet(fvBD, resolveAct=u'resolve', tnFvEpRetPolName=u'')

fvBD2 = cobra.model.fv.BD(fvTenant, ownerKey=u'', name=u'BD2', descr=u'', unkMacUcastAct=u'flood', arpFlood=u'yes', limitIpLearnToSubnets=u'no', llAddr=u'::', mac=u'00:22:BD:F8:19:FF', epMoveDetectMode=u'', unicastRoute=u'yes', ownerTag=u'', multiDstPktAct=u'bd-flood', unkMcastAct=u'flood')
...
fvBD3 = cobra.model.fv.BD(fvTenant, ownerKey=u'', name=u'failover-BD', descr=u'', unkMacUcastAct=u'flood', arpFlood=u'yes', limitIpLearnToSubnets=u'no', llAddr=u'::', mac=u'00:22:BD:F8:19:FF', epMoveDetectMode=u'', unicastRoute=u'yes', ownerTag=u'', multiDstPktAct=u'bd-flood', unkMcastAct=u'flood') 
...
fvRsDomAtt = cobra.model.fv.RsDomAtt(fvAEPg, classPref=u'useg', instrImedcy=u'immediate', resImedcy=u'immediate', encap=u'unknown', tDn=u'uni/vmmp-VMware/dom-vmware60-hybridcloud')
...
fvRsDomAtt2 = cobra.model.fv.RsDomAtt(fvAEPg2, instrImedcy=u'lazy', resImedcy=u'lazy', encap=u'unknown', tDn=u'uni/vmmp-VMware/dom-vmware60-hybridcloud')
fvRsCustQosPol2 = cobra.model.fv.RsCustQosPol(fvAEPg2, tnQosCustomPolName=u'')
fvRsBd2 = cobra.model.fv.RsBd(fvAEPg2, tnFvBDName=u'BD1')
fvAEPg3 = cobra.model.fv.AEPg(fvAp, prio=u'unspecified', matchT=u'AtleastOne', name=u'db', descr=u'')
fvRsDomAtt3 = cobra.model.fv.RsDomAtt(fvAEPg3, instrImedcy=u'lazy', resImedcy=u'lazy', encap=u'unknown', tDn=u'uni/vmmp-VMware/dom-vmware60-hybridcloud')
fvRsCustQosPol3 = cobra.model.fv.RsCustQosPol(fvAEPg3, tnQosCustomPolName=u'')
fvRsBd3 = cobra.model.fv.RsBd(fvAEPg3, tnFvBDName=u'BD2')
...
fvRsBd4 = cobra.model.fv.RsBd(fvAEPg4, tnFvBDName=u'failover-BD')
