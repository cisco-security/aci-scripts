...
vnsLDevVip = cobra.model.vns.LDevVip(fvTenant, isCopy='no', managed='yes', name='asa2-pbr', svcType='ADC', funcType='GoTo', promMode='no', devtype='PHYSICAL', packageModel='ASA5525', contextAware='single-Context', nameAlias='', trunking='no', mode='legacy-Mode')
...
vnsRsCIfPathAtt = cobra.model.vns.RsCIfPathAtt(vnsCIf, tDn='topology/pod-1/protpaths-101-102/pathep-[ASA5525-X-1-2-DATA]')
vnsCMgmt = cobra.model.vns.CMgmt(vnsCDev, host='%s' % csr_ip, name='', nameAlias='', port='44361')
vnsCMgmt2 = cobra.model.vns.CMgmt(vnsLDevVip, host='198.19.254.173', name='', nameAlias='', port='443')
vnsLIf = cobra.model.vns.LIf(vnsLDevVip, name='external', encap='unknown', nameAlias='')
vnsRsCIfAttN = cobra.model.vns.RsCIfAttN(vnsLIf, tDn='uni/tn-%s/lDevVip-asa2-pbr/cDev-_ASA_CNTXT_Active:pod%d/cIf-[p1]' % (tenant_login,pod_num))
...
vnsRsCIfAttN2 = cobra.model.vns.RsCIfAttN(vnsLIf2, tDn='uni/tn-%s/lDevVip-asa2-pbr/cDev-_ASA_CNTXT_Active:pod%d/cIf-[p1]' % (tenant_login,pod_num))
vnsRsMetaIf2 = cobra.model.vns.RsMetaIf(vnsLIf2, isConAndProv='no', tDn='uni/infra/mDev-CISCO-ASA-1.2/mIfLbl-internal')
vnsRsALDevToPhysDomP = cobra.model.vns.RsALDevToPhysDomP(vnsLDevVip, tDn='uni/phys-ASA5525-X-1-2-DATA')
